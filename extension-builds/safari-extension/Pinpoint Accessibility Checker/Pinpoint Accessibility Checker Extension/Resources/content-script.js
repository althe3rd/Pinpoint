...
(function() {
    ...
    async function injectAccessibilityChecker() {
        ...
        try {
            ...
            axeScript.src = chrome.runtime.getURL('axe-core.min.js');
            ...
            gsapScript.src = chrome.runtime.getURL('gsap.min.js');
            ...
            checkerScript.src = chrome.runtime.getURL('accessibility-checker.js');
