// Popup script for Pinpoint Accessibility Checker (Firefox)
    ...
    async function checkCurrentTab() {
        try {
            ...
            if (tab.status !== 'complete') {
                ...
                const tabUpdateListener = function(tabId, changeInfo) {
                    if (tabId === tab.id && changeInfo.status === 'complete') {
                        extensionAPI.tabs.onUpdated.removeListener(tabUpdateListener);
                        setStatus('Ready to check accessibility', 'info');
                        enableButton();
                    }
                };
                extensionAPI.tabs.onUpdated.addListener(tabUpdateListener);
                return;
            }
